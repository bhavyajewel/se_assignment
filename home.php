...
<body>
    ...
    <!-- <p>
        ...
        <a href="add.php" style="color: white;">Add New Data</a>
    ...
    <table width='80%' border=0>
        ...
        if ($result) {
            while ($res = mysqli_fetch_assoc($result)) {
                ...
                echo "<td>
        <a href=\"edit.php?id={$res['id']}\" style=\"color: white; background-color: green; padding: 5px 10px; text-decoration: none; border-radius: 5px;\">Edit</a> | 
        <a href=\"delete.php?id={$res['id']}\" onClick=\"return confirm('Are you sure you want to delete?')\" style=\"color: white; background-color: red; padding: 5px 10px; text-decoration: none; border-radius: 5px;\">Delete</a>
      </td>";
echo "</tr>";
    ...
    <!-- <p>
        <a href="add.php">Add New Data</a>
        <a href="add.php" style="color: cyan;">Add New Data</a>

    </p> -->
    <!-- <p>
    <a href="add.php" style="display: inline-block; background-color: blue; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; text-align: center;">Add New Data</a>
</p> -->

<p>
    <a href="add.php" style="display: inline-block; background-color: yellow; color: black; padding: 10px 20px; text-decoration: none; border-radius: 5px; text-align: center;">Add New Data</a>
</p>
    ...
    <h2 style="color: white;">Upload an Image</h2>

    <form action="" method="post" enctype="multipart/form-data">
        <!-- <label for="image">Choose an image to upload:</label> -->
        <input type="file" name="image" id="image" accept="image/*" required>
        <!-- <button type="submit">Upload</button> -->
        <button type="submit" style="background-color: blue; color: white; padding: 10px 20px; border: none; border-radius: 5px;">Upload</button>
